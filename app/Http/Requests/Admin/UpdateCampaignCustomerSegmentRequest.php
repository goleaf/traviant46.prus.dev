...
class UpdateCampaignCustomerSegmentRequest extends FormRequest
{
    ...
    {
        $segment = $this->route('campaignCustomerSegment');

        return CampaignCustomerSegmentResource::rules(
            $segment instanceof CampaignCustomerSegment ? $segment : null,
        );
    }
